...
**Source:** https://csharp-networking.com/chapter16/
**Date Captured:** 2025-07-28T16:32:49.513Z
...
## [#](#real-time-all-the-time-introducing-signalr)Real-Time, All the Time: Introducing SignalR
...
### [#](#the-pulse-of-real-time-understanding-the-problem-space)The Pulse of Real-Time: Understanding the Problem Space
...
### [#](#what-makes-signalr-shine-key-features-and-architecture)What Makes SignalR Shine: Key Features and Architecture
...
## [#](#the-signalr-toolkit-hubs-connections-and-protocols)The SignalR Toolkit: Hubs, Connections, and Protocols
...
### [#](#the-heart-of-the-hub-managing-real-time-communication)The Heart of the Hub: Managing Real-Time Communication
...
## [#](#building-the-backbone-setting-up-your-signalr-server)Building the Backbone: Setting Up Your SignalR Server
...
In this section, we’ll guide you through configuring your SignalR server in .NET, from installing dependencies to defining Hubs and mapping endpoints. This task, while challenging, is incredibly rewarding. Along the way, you’ll see how to customize your server to suit the unique needs of your application. Whether you’re building a live chat system, a collaborative tool, or a real-time dashboard, this foundational setup will prepare you to unlock SignalR’s full potential and start crafting remarkable user experiences. Let’s build your real-time backbone!

### [#](#laying-the-foundation-installing-and-configuring-signalr)Laying the Foundation: Installing and Configuring SignalR
...
#### [#](#creating-the-hub)Creating the Hub
...
### [#](#routing-real-time-traffic-mapping-endpoints)Routing Real-Time Traffic: Mapping Endpoints
...
#### [#](#adding-multiple-hubs)Adding Multiple Hubs
...
#### [#](#configuring-custom-endpoints)Configuring Custom Endpoints
...
#### [#](#adding-middleware-for-enhanced-routing)Adding Middleware for Enhanced Routing
...
### [#](#customizing-the-experience-hub-lifetime-events-and-logging)Customizing the Experience: Hub Lifetime Events and Logging
...
#### [#](#integrating-application-specific-logic)Integrating Application-Specific Logic
...
#### [#](#adding-logging-for-insights)Adding Logging for Insights
...
## [#](#talking-the-talk-creating-a-signalr-client)Talking the Talk: Creating a SignalR Client
...
### [#](#the-clients-perspective-how-signalr-bridges-the-gap)The Client’s Perspective: How SignalR Bridges the Gap
...
### [#](#starting-the-conversation-setting-up-a-signalr-client)Starting the Conversation: Setting Up a SignalR Client
...
#### [#](#listening-for-server-messages)Listening for Server Messages
...
#### [#](#managing-connection-lifecycle)Managing Connection Lifecycle
...
### [#](#listening-and-speaking-handling-methods-and-events)Listening and Speaking: Handling Methods and Events
...
#### [#](#supporting-streaming-data)Supporting Streaming Data
...
### [#](#signalr-everywhere-javascript-and-beyond)SignalR Everywhere: JavaScript and Beyond
...
#### [#](#mobile-and-cross-platform-apps)Mobile and Cross-Platform Apps
...
#### [#](#securing-cross-platform-clients)Securing Cross-Platform Clients
...
#### [#](#managing-compatibility)Managing Compatibility
...
### [#](#dealing-with-the-unexpected-reconnection-and-error-handling)Dealing with the Unexpected: Reconnection and Error Handling
...
#### [#](#implementing-automatic-reconnection)Implementing Automatic Reconnection
...
#### [#](#handling-errors-in-invocations)Handling Errors in Invocations
...
#### [#](#monitoring-reconnection-status)Monitoring Reconnection Status
...
## [#](#from-broadcasts-to-groups-advanced-signalr-features)From Broadcasts to Groups: Advanced SignalR Features
...
### [#](#the-power-of-many-mastering-broadcast-messaging)The Power of Many: Mastering Broadcast Messaging
...
#### [#](#customizing-broadcast-data)Customizing Broadcast Data
...
#### [#](#excluding-specific-clients)Excluding Specific Clients
...
#### [#](#grouped-broadcasting)Grouped Broadcasting
...
#### [#](#scaling-broadcasts)Scaling Broadcasts
...
### [#](#client-identity-unveiled-user-based-communication)Client Identity Unveiled: User-Based Communication
...
#### [#](#associating-connections-with-users)Associating Connections with Users
...
#### [#](#sending-messages-to-a-specific-user)Sending Messages to a Specific User
...
#### [#](#handling-multiple-connections-per-user)Handling Multiple Connections per User
...
#### [#](#customizing-user-identifiers)Customizing User Identifiers
...
### [#](#scaling-up-signalr-with-distributed-backplanes)Scaling Up: SignalR with Distributed Backplanes
...
#### [#](#introducing-distributed-backplanes)Introducing Distributed Backplanes
...
#### [#](#setting-up-redis-as-a-backplane)Setting Up Redis as a Backplane
...
#### [#](#scaling-with-sql-server)Scaling with SQL Server
...
#### [#](#using-azure-signalr-service)Using Azure SignalR Service
...
#### [#](#managing-connection-limits)Managing Connection Limits
...
## [#](#keeping-it-smooth-debugging-and-scaling-signalr-applications)Keeping It Smooth: Debugging and Scaling SignalR Applications
...
### [#](#a-real-time-litmus-test-testing-your-server-and-client)A Real-Time Litmus Test: Testing Your Server and Client
...
#### [#](#setting-up-unit-tests-for-hub-methods)Setting Up Unit Tests for Hub Methods
...
#### [#](#integration-testing-with-signalr-clients)Integration Testing with SignalR Clients
...
#### [#](#load-testing-your-signalr-application)Load Testing Your SignalR Application
...
### [#](#spotting-the-snags-debugging-signalr-applications)Spotting the Snags: Debugging SignalR Applications
...
#### [#](#enabling-signalr-logging)Enabling SignalR Logging
...
#### [#](#inspecting-hub-exceptions)Inspecting Hub Exceptions
...
#### [#](#monitoring-transport-protocols)Monitoring Transport Protocols
...
[Edit this page](https://github.com/cwoodruff/book-network-programming-csharp/blob/main/Chapter16/chapter16.md)

[PreviousChap 15 - Implementing Message Queuing](../chapter15/)

[NextChap 17 - Looking to the Future with QUIC](../chapter17/)