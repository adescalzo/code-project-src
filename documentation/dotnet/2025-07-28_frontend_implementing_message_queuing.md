...
**Source:** https://csharp-networking.com/chapter15/
**Date Captured:** 2025-07-28T16:32:43.002Z
...
# [#](#implementing-message-queuing)Implementing Message Queuing
...
### [#](#core-concepts-of-message-queuing)Core Concepts of Message Queuing
...
### [#](#the-role-of-message-queues-in-modern-applications)The Role of Message Queues in Modern Applications
...
### [#](#exploring-use-cases-for-message-queuing)Exploring Use Cases for Message Queuing
...
## [#](#exploring-message-queue-technologies)Exploring Message Queue Technologies
...
### [#](#overview-of-message-queue-technologies)Overview of Message Queue Technologies
...
### [#](#popular-message-queue-platforms)Popular Message Queue Platforms
...
#### [#](#rabbitmq-the-versatile-contender)RabbitMQ: The Versatile Contender
...
#### [#](#apache-kafka-the-event-streaming-powerhouse)Apache Kafka: The Event Streaming Powerhouse
...
#### [#](#azure-service-bus-the-enterprise-workhorse)Azure Service Bus: The Enterprise Workhorse
...
#### [#](#amazon-sqs-simplicity-at-scale)Amazon SQS: Simplicity at Scale
...
#### [#](#delivery-guarantees-getting-the-message-across)Delivery Guarantees: Getting the Message Across
...
#### [#](#scalability-and-performance-handling-the-heat)Scalability and Performance: Handling the Heat
...
#### [#](#integration-and-ecosystem-plugging-it-all-together)Integration and Ecosystem: Plugging It All Together
...
## [#](#implementing-a-message-queue-in-c)Implementing a Message Queue in C#
...
### [#](#creating-a-message-producer)Creating a Message Producer
...
### [#](#building-a-message-consumer)Building a Message Consumer
...
### [#](#handling-acknowledgments-and-errors)Handling Acknowledgments and Errors
...
### [#](#testing-and-deploying-the-message-queue-solution)Testing and Deploying the Message Queue Solution
...
#### [#](#unit-testing-the-producer-and-consumer)Unit Testing the Producer and Consumer
...
#### [#](#integration-testing-with-a-live-queue)Integration Testing with a Live Queue
...
## [#](#advanced-topics-in-message-queuing)Advanced Topics in Message Queuing
...
### [#](#optimizing-performance-and-scalability)Optimizing Performance and Scalability
...
### [#](#securing-message-queues)Securing Message Queues
...
### [#](#improving-throughput-and-latency)Improving Throughput and Latency
...
### [#](#scaling-message-queuing-systems)Scaling Message Queuing Systems
...
[Edit this page](https://github.com/cwoodruff/book-network-programming-csharp/blob/main/Chapter15/chapter15.md)

[PreviousChap 14 - Working with Web​Hooks](../chapter14/)

[NextChap 16 - Using Signal​R](../chapter16/)