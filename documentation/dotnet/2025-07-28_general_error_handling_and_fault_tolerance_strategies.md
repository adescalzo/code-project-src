...
### [#](#handling-multiple-exceptions-at-once-and-filtering-on-exceptions)Handling Multiple Exceptions at Once and Filtering on Exceptions
...
##### [#](#installing-polly-using-the-net-cli)Installing Polly using the .NET CLI
