...
```markdown
**Source:** https://csharp-networking.com/chapter03/
**Date Captured:** 2025-07-28T16:30:57.749Z
...
# [#](#importance-of-socket-programming)Importance of socket programming
...
## [#](#role-of-sockets)Role of sockets
...
### [#](#stream-sockets-tcp-sockets)Stream sockets (TCP Sockets)
...
### [#](#datagram-sockets-udp-sockets)Datagram sockets (UDP Sockets)
...
### [#](#sequential-packet-sockets)Sequential packet sockets
...
# [#](#overview-of-socket-programming)Overview of socket programming
...
## [#](#socket-creation-and-configuration)Socket creation and configuration
...
### [#](#the-anatomy-of-a-socket)The anatomy of a socket
...
## [#](#socket-addressing)Socket addressing
...
### [#](#fundamentals-of-socket-addressing)Fundamentals of socket addressing
...
### [#](#special-port-numbers)Special port numbers
...
## [#](#socket-communication-modes)Socket communication modes
...
# [#](#client-side-socket-programming)Client-side socket programming
...
## [#](#socket-creation-and-connection)Socket creation and connection
...
### [#](#sending-data-in-bytes)Sending data in bytes
...
### [#](#transmitting-data-using-the-socket)Transmitting data using the socket
...
### [#](#handling-larger-data)Handling larger data
...
## [#](#ensuring-reliable-data-transmission)Ensuring reliable data transmission
...
### [#](#basics-of-data-reception)Basics of data reception
...
### [#](#converting-received-bytes)Converting received bytes
...
### [#](#handling-data-of-unknown-length)Handling data of unknown length
...
### [#](#recognizing-potential-errors)Recognizing potential errors
...
### [#](#retrieving-the-local-endpoint)Retrieving the Local Endpoint
...
### [#](#blocking-nature-of-accept)Blocking nature of Accept
...
### [#](#handling-multiple-connections-using-threading)Handling multiple connections using threading
...
### [#](#handling-multiple-connections-using-asynchronous-socket-operations-and-threading)Handling multiple connections using asynchronous socket operations and threading
...
### [#](#threads-for-individual-clients)Threads for individual clients
...
### [#](#task-based-approach-with-taskrun)Task-based approach with Task.Run
...
### [#](#concurrent-collections-for-client-management)Concurrent collections for client management
...
## [#](#data-exchange-with-clients)Data exchange with clients
...
### [#](#sending-data-to-clients)Sending data to clients
...
### [#](#receiving-data-from-clients)Receiving data from clients
...
### [#](#handling-variable-length-messages)Handling variable-length messages
...
### [#](#identifying-client-sessions)Identifying client sessions
...
### [#](#graceful-session-termination)Graceful session termination
...
### [#](#handling-session-persistence)Handling session persistence
...
### [#](#catching-socket-exceptions)Catching socket exceptions
...
### [#](#handling-other-exceptions)Handling other exceptions
...
[Edit this page](https://github.com/cwoodruff/book-network-programming-csharp/blob/main/Chapter03/chapter03.md)

[PreviousChap 2 - Fundamentals of Networking Concepts](../chapter02/)

[NextChap 4 - Asynchronous Programming with Async/Await](../chapter04/)