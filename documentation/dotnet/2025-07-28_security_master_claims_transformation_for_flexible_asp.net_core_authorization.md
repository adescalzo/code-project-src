...
## [How Does Claims Transformation Work?](#how-does-claims-transformation-work)
...
![](data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%271614%27%20height=%271357%27/%3e)![Claims transformation sequence diagram.](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)

![Claims transformation sequence diagram.](/blogs/mnw_084/claims_transformation_sequence_diagram.png?imwidth=3840)

Let's see how to implement this in ASP.NET Core.

## [Simple Claims Transformation](#simple-claims-transformation)
